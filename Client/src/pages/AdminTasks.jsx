...
export default function AdminTasks() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => taskAPI.list({ page, limit: 15, status: statusFilter || undefined }).then(r => r.data),
    ...
    <Layout>
      ...
      {showModal && (
        <CreateTaskModal
          ...
          onCreated={() => { setShowModal(false); qc.invalidateQueries({ queryKey: ['admin-tasks'] }); }}
        />
      )}
    </Layout>
  );
